...
class ArtsAndCulture extends StatefulWidget {
  @override
  State createState() { //for nav bar
    return _ArtsAndCultureState();
  }
// _ActivityCategoriesState createState() => _ActivityCategoriesState();
}

class _ArtsAndCultureState extends State<ArtsAndCulture> {
  Widget _child; //for nav bar

  @override
  void initState() { //for nav bar
    _child = ArtsAndCulture();
    super.initState();
  }
