...
class SportsAndRecreation extends StatefulWidget {
  @override
  State createState() { //for nav bar
    return _SportsAndRecreationState();
  }
// _ActivityCategoriesState createState() => _ActivityCategoriesState();
}

class _SportsAndRecreationState extends State<SportsAndRecreation> {
  Widget _child; //for nav bar

  @override
  void initState() { //for nav bar
    _child = SportsAndRecreation();
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text("Sports and Recreation"),
      ),
      body: GridView.count(
