...
class ToursAndSightseeing extends StatefulWidget {
  @override
  State createState() { //for nav bar
    return _ToursAndSightseeingState();
  }
// _ActivityCategoriesState createState() => _ActivityCategoriesState();
}

class _ToursAndSightseeingState extends State<ToursAndSightseeing> {
  Widget _child; //for nav bar

  @override
  void initState() { //for nav bar
    _child = ToursAndSightseeing();
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text("Tours and Sightseeing"),
      ),
      body: GridView.count(
