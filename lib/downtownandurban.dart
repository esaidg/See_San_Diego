...
class DowntownAndUrban extends StatefulWidget {
  @override
  State createState() { //for nav bar
    return _DowntownAndUrbanState();
  }
// _ActivityCategoriesState createState() => _ActivityCategoriesState();
}

class _DowntownAndUrbanState extends State<DowntownAndUrban> {
  Widget _child; //for nav bar

  @override
  void initState() { //for nav bar
    _child = DowntownAndUrban();
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text("Downtown and Urban Neighborhoods"),
      ),
      body: GridView.count(
