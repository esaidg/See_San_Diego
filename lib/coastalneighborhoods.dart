...
class CoastalNeighborhoods extends StatefulWidget {
  @override
  State createState() { //for nav bar
    return _CoastalNeighborhoodsState();
  }
// _ActivityCategoriesState createState() => _ActivityCategoriesState();
}

class _CoastalNeighborhoodsState extends State<CoastalNeighborhoods> {
  Widget _child; //for nav bar

  @override
  void initState() { //for nav bar
    _child = CoastalNeighborhoods();
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text("Coastal Neighborhoods"),
      ),
      body: GridView.count(
