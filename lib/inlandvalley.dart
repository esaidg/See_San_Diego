...
class InlandValley extends StatefulWidget {
  @override
  State createState() { //for nav bar
    return _InlandValleyState();
  }
// _ActivityCategoriesState createState() => _ActivityCategoriesState();
}

class _InlandValleyState extends State<InlandValley> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text("Inland Valley, Mountain, and Desert Neighborhoods"),
      ),
      body: GridView.count(
