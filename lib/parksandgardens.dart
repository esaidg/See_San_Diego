...
class ParksAndGardens extends StatefulWidget {
  @override
  State createState() { //for nav bar
    return _ParksAndGardensState();
  }
// _ActivityCategoriesState createState() => _ActivityCategoriesState();
}

class _ParksAndGardensState extends State<ParksAndGardens> {
  Widget _child; //for nav bar

  @override
  void initState() { //for nav bar
    _child = ParksAndGardens();
    super.initState();
  }
